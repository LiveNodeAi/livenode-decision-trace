...
- Semantic grounding uses NFKC plus whitespace collapse/trim only. Every supplied evidence value and link source excerpt must occur in the memo; case, punctuation, and ellipses are not fuzzed. Mismatches use the existing exactly-once malformed retry.
...
- Semantic-grounding targeted suite: 13/13 PASS after RED showed hallucinated evidence/link acceptance.
- Full Vitest: 65/65 PASS.
